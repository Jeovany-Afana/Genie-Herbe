                        ...
                        <motion.div className="text-center space-y-12">
                            ...
                            <motion.div className="flex flex-col items-center space-y-4">
                                ...
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, scaleX: 1, transition: { delay: 2.2, duration: 0.5 } }}
            ...
            >
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                            ...
                            >
                                <AnimatePresence>
                                    {revealingClue === index && (
                                        <motion.div
                                            initial={{ scale: 0 }}
                                            animate={{ scale: 10, opacity: 0, transition: { duration: 0.8 } }}
                      ...
                      <span className={`font-medium ${revealedClues.includes(index) ? textColor : 'text-gray-400'}`}>
                ...
                >
                    ...
                    <div className="flex gap-3">
                        <motion.div className="flex-1 relative" whileHover={{ y: -3 }}>
                            <input
                                type="text"
                                value={userGuess}
                    ...
                    {(revealedClues.length === question.clues?.length || showSolution) && (
                        <motion.div
                            ...
                            exit={{
                                opacity: 0,
                                y: 50,
                                transition: { duration: 1.5, delay: 3 } // Ici, le message reste 3 secondes de plus avant de disparaître
                            }}
                            className={`p-6 rounded-xl border-2 mt-6 text-center ${
                                spookyMode ? 'bg-purple-900/20 border-purple-500' : 'bg-yellow-900/20 border-yellow-500'
                            }`}
                        >
                            <div className="flex flex-col items-center">
                                ...
                                <h4
                                    className={`text-2xl font-bold mb-3 ${spookyMode ? 'text-purple-400' : 'text-yellow-400'}`}
                                >
                ...
                {!showSolution && revealedClues.length < (question.clues?.length || 0) && (
                    <motion.button
                        ...
                        className={`w-full py-3 rounded-xl font-bold mt-6 flex items-center justify-center gap-2 ${
                            spookyMode
